...
@OnlyIn(Dist.CLIENT)
public class BlaraolsModel extends AnimatedGeoModel<RollyEntity> {
    ...
    public BlaraolsModel(ModelPart pRoot) {
        this.root = pRoot;
     ...
     */
    public void setupAnim(BlaraolsEntity pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
    ...
    public ResourceLocation getModelLocation(RollyEntity object) {
        return new ResourceLocation(GarnetMod.MOD_ID, "geo/blaraols.geo.json");
    }
    ...
    public ResourceLocation getAnimationFileLocation(RollyEntity animatable) {
        return new ResourceLocation(GarnetMod.MOD_ID, "animations/blaraols.animation.json");
    }
}